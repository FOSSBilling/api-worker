...
export const mockReleases: Releases = {
  ...
  '0.5.1': {
    ...
    minimum_php_version: '8.1',
    download_url: 'https://github.com/FOSSBilling/FOSSBilling/releases/download/0.5.1/FOSSBilling.zip',
    size_bytes: 1025000,
    is_prerelease: false,
  ...
  '0.5.2': {
    ...
    minimum_php_version: '8.1',
    download_url: 'https://github.com/FOSSBilling/FOSSBilling/releases/download/0.5.2/FOSSBilling.zip',
    size_bytes: 1026000,
    is_prerelease: false,
